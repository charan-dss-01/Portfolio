...
const projects: Project[] = [
    {
      ...
      link: "https://agriconnect07.netlify.app/"
    },
    {
      title: "Event Ease",
      description:
        "Event Ease is a full-stack Next.js application designed to simplify event management and ticketing. With user-friendly UI built in Tailwind CSS, it features real-time updates and admin controls.",
      image: "/assets/ee.png",
      documentation: "",
      ppt: "",
      technologies: ["Next.js", "Tailwind CSS", "MongoDB Atlas", "Cloudinary"],
      features: [
    ...
    },
    {
      ...
      description:
        "Weather Masters is a Next.js-based web app that delivers real-time weather updates using external APIs. It features a responsive UI built with Tailwind CSS for an enhanced user experience.",
      image: "/assets/wm2.PNG",
      ...
      link: "https://weathermasterss.netlify.app/"
    },
    {
      title: "Cipher Hub",
      description:
